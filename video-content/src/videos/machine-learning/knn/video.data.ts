// ═══════════════════════════════════════════════════════════
// KNN 视频数据文件 — 做这个视频唯一需要写的文件
// KNN Video Data — The ONLY file needed for this video
//
// 素材来源:
//   - Wikipedia: Fix & Hodges, Cover & Hart, Bentley 人物故事
//   - 教科书: ISL Ch.2 (偏差-方差), PRML Ch.2.5.2 (KNN理论)
//   - 论文: Cover & Hart 1967, Indyk & Motwani 1998
// ═══════════════════════════════════════════════════════════
...
export const KNN_VIDEO: VideoData = {
  meta: {
    topic: 'knn',
    course: 'machine-learning',
    title: 'KNN — 从抄作业到 AI 基础设施',
    textbookSource: 'ISL Ch.2, PRML Ch.2.5.2',
    contentSources: ['Wikipedia', 'ISL', 'PRML', 'Cover & Hart 1967'],
  ...
  narration: {
    ...
    timestamps: [
      ...
      { start: 25.24, end: 38.36 },
      { start: 38.66, end: 50.74 },
      { start: 51.04, end: 84.56 },
      { start: 84.86, end: 112.46 },
      { start: 112.76, end: 126.84 },
      { start: 127.14, end: 145.7 },
      { start: 146.0, end: 169.2 },
      { start: 169.5, end: 192.7 },
      { start: 193.0, end: 210.28 },
      { start: 210.58, end: 229.7 },
      { start: 230.0, end: 247.36 },
      { start: 247.66, end: 272.06 },
      { start: 272.36, end: 291.72 },
      { start: 292.02, end: 317.78 },
      { start: 318.08, end: 332.48 },
      { start: 332.78, end: 359.58 },
      { start: 359.88, end: 380.28 },
      { start: 380.58, end: 395.3 },
    ],
    subtitles: [
      { start: 0.0, end: 13.52, text: '1951年，美国空军出了个难题：怎么看一堆体检数据，自动判断一个飞行员适不适合执行高危任务——这叫分类。' },
      { start: 13.82, end: 24.94, text: '两个统计学家Fix和Hodges想了个蠢到家的方法：找到跟你最像的那个人，看他被划成什么类别，直接抄他的答案。' },
      { start: 25.24, end: 38.36, text: '怎么定义最像？用距离——就是初中学的勾股定理推广到更多维度。距离小就是像，距离大就是不像。' },
      { start: 38.66, end: 50.74, text: '这份报告写完……然后呢？没人看。没发表、没引用、石沉大海。' },
      { start: 51.04, end: 84.56, text: '直到16年后，1967年，Cover和Hart证明了这个蠢方法在数学上是靠谱的。只看一个最近邻，误差最多是上帝视角的两倍。' },
      { start: 84.86, end: 112.46, text: '所以KNN——K近邻——一句话：考试不会做的题，看旁边K个同学写的啥，哪个答案多就抄哪个。' },
      { start: 112.76, end: 126.84, text: 'K等于1——只问旁边一个人，那人要是学渣你就完了。K等于100——问全班，那你不如直接看全班最多人选的答案了。' },
      { start: 127.14, end: 145.7, text: 'K太小容易被噪声带偏——过拟合。K太大看不到局部规律——欠拟合。怎么选？让数据自己说话——交叉验证。' },
      { start: 146.0, end: 169.2, text: 'KNN训练时候干了啥？啥也没干。等你来问才开始翻——所以叫惰性学习。训练零点一秒，预测可能要十分钟。' },
      { start: 169.5, end: 192.7, text: '长得像的东西，标签也像。你妈和你阿姨长得像，基因也接近。KNN只不过把它变成了算法。' },
      { start: 193.0, end: 210.28, text: '但你量像不像的尺子得准。如果尺子是歪的，量出来最近的那个人其实离你八丈远——垃圾进、垃圾出。' },
      { start: 210.58, end: 229.7, text: '数据得够多。你在5个人的公司里问旁边的人怎么看——那叫掷骰子。KNN需要足够多的邻居才能统计出可靠的结论。' },
      { start: 230.0, end: 247.36, text: '三条公理缺一不可：局部连续、距离管用、数据够多。三个全满足——有定理保底；任何一个不满足——全崩。' },
      { start: 247.66, end: 272.06, text: '最常见的翻车：忘记归一化。一列是年收入一万块，另一列是评分零点五。距离全被收入主导了。' },
      { start: 272.36, end: 291.72, text: '数据维度一高，高维空间里所有点的距离都差不多。最近邻三个字没意义了——这叫维度灾难。' },
      { start: 292.02, end: 317.78, text: '怎么办？降维——PCA压到100维以下。或者换余弦距离——量方向而不是量位置。' },
      { start: 318.08, end: 332.48, text: '1975年Bentley发明了KD-Tree——把搜索从跟每个人比一遍变成了二分查找。低维数据从此秒搜。' },
      { start: 332.78, end: 359.58, text: 'KD-Tree在高维也废了。1999年LSH不找最近的，找差不多近的就行。2017年Meta搞了FAISS——十亿级向量，毫秒级搜索。' },
      { start: 359.88, end: 380.28, text: '你现在用ChatGPT问问题，本质就是在embedding空间做KNN搜索。七十多年后变成了AI时代的基础设施。' },
      { start: 380.58, end: 395.3, text: '下期讲LOF——用KNN抓诈骗犯。关注不迷路。' },
    ],
  },
  ...
  scenes: [
    // ══════ Scene 01: 1951 开场 ══════
    {
      ...
      visuals: [
        {
          block: 'ImageDisplay',
          data: { src: 'photos/knn/repr_person_fix.jpg', caption: 'Evelyn Fix (1904–1965)' },
        },
        {
          block: 'StatCards',
          data: {
    ...
    // ══════ Scene 04: 石沉大海 ══════
    {
      ...
      visuals: [
        {
          block: 'ImageDisplay',
          data: { src: 'photos/knn/repr_paper_fix_hodges_1951.png', caption: 'Fix & Hodges (1951) 原始报告' },
        },
        {
          block: 'Timeline',
          data: {
    ...
    // ══════ Scene 05: Cover-Hart 定理 ══════
    {
      ...
      visuals: [
        {
          block: 'ImageDisplay',
          data: { src: 'photos/knn/repr_person_cover.jpg', caption: 'Thomas Cover (Stanford)' },
        },
        {
          block: 'FormulaBlock',
          data: {
            latex: 'P^{*} \\leq P_{\\text{1-NN}} \\leq 2P^{*}',
            label: '最近邻误差 ≤ 最优误差的 2 倍',
            color: '#ffd700',
          },
        },
      ],
    ...
    // ══════ Scene 13: 三公理总结 ══════
    {
      ...
      visuals: [
        ...
        },
        {
          block: 'FormulaBlock',
          data: {
            latex: 'P^{*} \\leq P_{\\text{NN}} \\leq 2P^{*}',
            label: '三条全满足 → Cover-Hart 保底',
          },
        },
      ],
      points: [
    ...
    // ══════ Scene 17: KD-Tree ══════
    {
      ...
      visuals: [
        {
          block: 'ImageDisplay',
          data: { src: 'photos/knn/repr_person_bentley.jpg', caption: 'Jon Bentley' },
        },
        {
          block: 'ComparisonSplit',
          data: {
