...
>
> Kernel size: 3×3, Input: 5×5, Stride: 1, Padding: 0
> - 卷积核尺寸：3×3, 输入：5×5, 步长：1, 填充：0
>
> Output size = ((5-3)/1 + 1) × ((5-3)/1 + 1) = **3 × 3**
> - 输出尺寸 = ((5-3)/1 + 1) × ((5-3)/1 + 1) = **3 × 3**
>
> Each output element = sum of element-wise multiplication:
> - 每个输出元素 = 对应位置逐元素相乘之和
> - 💡 技巧：Kernel 左列=-2, 中列=0, 右列=2，所以每个位置 = -2×(左列之和) + 2×(右列之和)
>
> **Position (0,0):** `1×(-2)+5×0+3×2 + 5×(-2)+9×0+6×2 + 7×(-2)+1×0+9×2 = (-2+6)+(-10+12)+(-14+18) = 4+2+4 = 10`
>
> **Position (0,1):** `5×(-2)+3×0+9×2 + 9×(-2)+6×0+1×2 + 1×(-2)+9×0+0×2 = (-10+18)+(-18+2)+(-2+0) = 8-16-2 = -10`
>
> **Position (0,2):** `3×(-2)+9×0+0×2 + 6×(-2)+1×0+2×2 + 9×(-2)+0×0+1×2 = (-6+0)+(-12+4)+(-18+2) = -6-8-16 = -30`
>
> **Position (1,0):** `5×(-2)+9×0+6×2 + 7×(-2)+1×0+9×2 + 8×(-2)+2×0+3×2 = (-10+12)+(-14+18)+(-16+6) = 2+4-10 = -4`
>
> **Position (1,1):** `9×(-2)+6×0+1×2 + 1×(-2)+9×0+0×2 + 2×(-2)+3×0+4×2 = (-18+2)+(-2+0)+(-4+8) = -16-2+4 = -14`
>
> **Position (1,2):** `6×(-2)+1×0+2×2 + 9×(-2)+0×0+1×2 + 3×(-2)+4×0+8×2 = (-12+4)+(-18+2)+(-6+16) = -8-16+10 = -14`
>
> **Position (2,0):** `7×(-2)+1×0+9×2 + 8×(-2)+2×0+3×2 + 6×(-2)+7×0+8×2 = (-14+18)+(-16+6)+(-12+16) = 4-10+4 = -2`
>
> **Position (2,1):** `1×(-2)+9×0+0×2 + 2×(-2)+3×0+4×2 + 7×(-2)+8×0+5×2 = (-2+0)+(-4+8)+(-14+10) = -2+4-4 = -2`
>
> **Position (2,2):** `9×(-2)+0×0+1×2 + 3×(-2)+4×0+8×2 + 8×(-2)+5×0+9×2 = (-18+2)+(-6+16)+(-16+18) = -16+10+2 = -4`
>
> **Result Matrix (结果矩阵):**
>
> ```
