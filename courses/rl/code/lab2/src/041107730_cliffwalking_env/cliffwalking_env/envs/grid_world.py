# cliffwalking_env/envs/grid_world.py
...
class GridWorldEnv(gym.Env):
    ...
    def __init__(self, render_mode=None, size=5):
        ...
        to the window that we draw to. `self.clock` will be a clock that
        is used to ensure that the environment is rendered at the correct
