---
name: learning-concept_coverage
...
- `courses/{course}/notes/{topic_key}_concepts.md`

Optional companion outputs when the workflow asks for them:

- `courses/{course}/notes/{topic_key}_math.md`
- `courses/{course}/notes/{topic_key}_code.md`
...
- `courses/{course}/notes/{topic_key}_slides.md`
- `courses/{course}/notes/{topic_key}_storyline.md` if available
- relevant quiz files
- relevant lab files
...
- create `{topic_key}_concepts.md`
- do not create `{topic_key}_cheatsheet.md` from this skill
