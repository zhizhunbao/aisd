...
- Generated artifact prefix uses `topic_key`
- Recommended `topic_key` format: `讲次_主题`
- Example: `lecture9_transformer`
- Generated files should therefore look like `lecture9_transformer_slides.md`, `lecture9_transformer_storyline.md`, `lecture9_transformer_concepts.md`
